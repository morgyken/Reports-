        ...
        $menu->group('Dashboard', function (Group $group) {
            $group->item('Reports', function (Item $item) {
                ...
                $item->item('Patient Management', function (Item $item) {
                    ...
                    $item->item('Client Report', function (Item $item) {
                        $item->icon('fa fa-users');
                        $item->route('reports.client.departments');
                    });
                    $item->item('Patients Seen', function (Item $item) {
                        $item->icon('fa fa-user-md');
                        $item->route('reports.client.doctors');
                    });
                    $item->item('Hypertension Patients', function (Item $item) {
                        $item->icon('fa fa-electricity');
                        $item->route('reports.patients.hypertension');
                    });
